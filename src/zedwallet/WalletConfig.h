...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "ever";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "ecx";
    ...
    const std::string daemonName = "EveryCashd";
    ...
    const std::string contactLink = "http://reddit.com/r/everycash";
